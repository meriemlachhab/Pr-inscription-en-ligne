...
?>
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-8 mx-auto">
            <div class="mt-5 pt-4 card shadow">
               ...
               <div class="mb-3">
                ...
                <div class=" mt-3 mb-3">
                  ...
                  <input type="password" class="form-control" name="password" id="password" aria-describedby="helpId" placeholder="" value="<?php echo $etudiant->password; ?>">
                  <small id="helpId" class="form-text  fw-bold text-danger">Champs obligatoire</small>
                </div>
               </div>
            ...
            <button class="my-4 mx-auto btn btn-primary d-block w-25 text-light fw-bold" type="submit" name="submit">Modifier</button>
        </div>
        </form>
        </div> 
    </div>
