...
?>
  <div class="container-fluid">
    <div class="row">
      <div class="menubar shadow" style="background-color: white;">
        <?php include('includes/navbar.php'); ?>
      </div>
    </div>
    <div class="row mt-4">
      <div class="text-center">
        <h1 class="inscp-title">Inscription en ligne</h1>
        <h4>Toute information fausse le candidat sera éliminé</h4>
      </div>
    </div>
    <div class="row">
    ...
    <div class="row">
      <div class="col-sm-12 col-md-10 mx-auto">
        <div class="mt-5 pt-4 card shadow">
          <h4 class="text-center">Inscription en ligne</h4>
          <h5 class="text-center text-danger mb-3 ">Touts les champs sont obligatoires</h5>
            ...
            <div class="d-flex card-form flex-row justify-content-center">
              ...
              <div class=" col-md-3 mx-5">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="cin" id="cin" aria-describedby="helpId" placeholder="">
                  <small id="helpId" class="form-text  fw-bold text-danger">Champs obligatoire</small>
                </div>
                <div class="mb-3">
              ...
              <div class=" col-md-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" name="cne" id="cne" aria-describedby="helpId" placeholder="">
                  <small id="helpId" class="form-text  fw-bold text-danger">Champs obligatoire</small>
                </div>
                <div class="mb-3">
